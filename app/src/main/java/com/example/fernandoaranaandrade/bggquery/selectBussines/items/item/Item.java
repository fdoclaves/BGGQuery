...
import com.example.fernandoaranaandrade.bggquery.selectBussines.items.item.stats.Stats;
import com.example.fernandoaranaandrade.bggquery.selectBussines.items.item.status.Status;
